...
export default function Products({header, grid}){
     const products = [
              ...
              <Link key={index} to="product-review" className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="py-6 px-4 flex items-center justify-between">
                  <div className='w-full'>
                    ...
                    <p className="text-sm mb-4 text-gray-900"># {product.price}</p>
                  </div>
                  <div className="w-full flex items-center justify-end gap-4">
                      <ShoppingCart size={25} color='#545454' />
                      <Share2 size={25} color='#545454' />
                  </div>
